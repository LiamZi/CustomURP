...
float2 RayTraceSphere(float3 sphereCenter, float sphereRadius, float3 pos, float3 rayDir)
{
...
{
    float2 cloudDstMin = RayTraceSphere(sphereCenter, heightMin + earthRadius, pos, rayDir);
    float2 cloudDstMax = RayTraceSphere(sphereCenter, heightMax + earthRadius, pos, rayDir);
