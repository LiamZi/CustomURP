...
UNITY_INSTANCING_BUFFER_START(UnityPerMaterial)
    ...
    UNITY_DEFINE_INSTANCED_PROP(float, _DefaultBending)
    UNITY_DEFINE_INSTANCED_PROP(float, _Amplitude)
    UNITY_DEFINE_INSTANCED_PROP(float, _AmplitudeOffset)
    UNITY_DEFINE_INSTANCED_PROP(float, _Frequency)
    UNITY_DEFINE_INSTANCED_PROP(float, _FrequencyOffset)
    UNITY_DEFINE_INSTANCED_PROP(float, _Phase)
    UNITY_DEFINE_INSTANCED_PROP(float, _WindDir)
    UNITY_DEFINE_INSTANCED_PROP(float, _WindDirOffset)
    UNITY_DEFINE_INSTANCED_PROP(float, _MaxHeight)
    UNITY_DEFINE_INSTANCED_PROP(float4, _NoiseTextureTilling)
    UNITY_DEFINE_INSTANCED_PROP(float4, _NoisePannerSpeed)
